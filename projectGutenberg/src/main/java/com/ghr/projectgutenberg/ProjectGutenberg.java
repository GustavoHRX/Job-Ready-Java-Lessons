package com.ghr.projectgutenberg;

public class ProjectGutenberg { // Exercise about print and println and how to they work on the different lines of code
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" printing vasy amount to the waiting console with ease");
    }
}
